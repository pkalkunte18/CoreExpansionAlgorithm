...
def areUnassigned(g):
    ...
    for i in range(0, len(g.nodes)):
        ...
        if(tempp[0] == -1):
            ...
            if(len(tempp) > 1): 
                print(this, "is overlapping in", len(tempp), "communities")
                numOverlapping+=1
    print("total unassigned: ", count)
    print("total overlapping:", numOverlapping)
